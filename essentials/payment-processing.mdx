...
<Note>
  ...
  fees. You can optionally **pass the platform fee to vendors** so they cover
  the 2%.
</Note>
...
<AccordionGroup>
  ...
  <Accordion icon="percent" title="What are the fees?">
    Seen Markets charges 2% on top of Stripe's standard processing fees. You
    can pass the 2% to vendors in your payment settings.
  </Accordion>
